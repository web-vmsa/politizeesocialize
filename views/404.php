...
<head>
	<!-- Primary Meta Tags -->
	<title>Politize e socialize - Página não encontrada</title>
	<meta name="title" content="Politize e socialize - Página não encontrada">
	<meta name="description" content="A página que você procura não existe ou não foi encontrada.">
	<meta charset="utf-8">
	...
	<meta property="og:url" content="<?php echo BASE_URL; ?>404">
	<meta property="og:title" content="Politize e socialize - Página não encontrada">
	<meta property="og:description" content="A página que você procura não existe ou não foi encontrada.">
	<meta property="og:image" content="<?php echo BASE_URL; ?>assets/images/logotipo-politizeesocialize.png">

	<!-- Twitter -->
	<meta property="twitter:card" content="summary_large_image">
	<meta property="twitter:url" content="<?php echo BASE_URL; ?>404">
	<meta property="twitter:title" content="Politize e socialize - Página não encontrada">
	<meta property="twitter:description" content="A página que você procura não existe ou não foi encontrada.">
...
<body>
	...
	<div class="body-notfound">
		<h2 class="cursor-default"><span>404</span></h2>
		<h2 class="cursor-default">PAGE NOT FOUND</h2>

		<p class="cursor-default">A PÁGINA OU LINK QUE VOCÊ PROCURA NÃO EXISTE, LAMENTAMOS.</p>
	</div>
